        ...
        ?>
            <li class="woocommerce-mini-cart-item <?php echo esc_attr(apply_filters('woocommerce_mini_cart_item_class', 'mini_cart_item', $cart_item, $cart_item_key)); ?>">
              ...
              <?php if (empty($product_permalink)) : ?>
                <div style="width: 100%; display:flex;" class="mini-cart_product_data">
                  <a href="<?php echo esc_url($product_permalink); ?>">
                    <?php echo $thumbnail; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped 
                    ?>
                  </a>
                  <div class="mini-cart_product_name">
      ...
      <div class="ux-mini-cart-footer">
        ...
        <p class="woocommerce-mini-cart__buttons buttons">
          ...
          if ($total_order > $minimum_order) {
            echo '<a href="' . esc_url(wc_get_checkout_url()) . '" class="button checkout wc-forward button-checkout-minicart"> Checkout </a>';
          } else {
